...
- Allow the player to select a stencil.
    - Make an instance of the selected stencil with alpha set to 0.5
- Allow the player to move the stencil.
- Clicking the hole in the stencil places the shape down.
- Allow the player to rotate the stencil by 90 degrees.
    - Press r or double click to rotate the stencil.
- Make a scene with a view of some image that you're trying to match.

# DONE:
- Add a stencil with a triangle.
- Add a stencil with a rectangle.
